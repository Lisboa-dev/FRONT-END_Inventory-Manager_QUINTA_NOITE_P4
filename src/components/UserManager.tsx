  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#121212', color: '#e0e0e0' }}>
      <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        {error && (
          <div style={{ backgroundColor: '#4a1818', color: '#ff9999', padding: '10px', marginBottom: '10px', borderRadius: '4px' }}>
            {error}
          </div>
        )}
        ...
        <form
          ...
          style={{ marginBottom: '30px', padding: '20px', backgroundColor: '#1e1e1e', borderRadius: '8px' }}
        >
